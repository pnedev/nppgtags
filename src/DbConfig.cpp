...
const TCHAR DbConfig::cInfo[] =
        _T("# Database configuration file for Notepad++ NppGTags plugin\n")
 ...
 *  \brief
 */
void DbConfig::GetDefaultCfgFile(CPath& cfgFile)
{
 ...
 *  \brief
 */
bool DbConfig::LoadFromFile(const TCHAR* file)
{
    SetDefaults();
 ...
 *  \brief
 */
bool DbConfig::SaveToFile(const TCHAR* file) const
{
    CPath cfgFile(file);
    if (file == NULL)
        GetDefaultCfgFile(cfgFile);
