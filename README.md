...
The default is the built-in *GTags* parser but it supports only C, C++, Java and several other languages at the time this doc was written.
*Ctags* supports considerably more languages but does not allow reference search.
...
In the dialog simply select your project's top folder and GTags will index recursively all supported by the chosen parser source files. It will create database files (*GTAGS*, *GRTAGS* and *GPATH*) in the selected folder.
